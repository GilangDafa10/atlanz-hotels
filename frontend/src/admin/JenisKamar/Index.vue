<template>
  <div class="min-h-screen bg-gray-50 p-6 md:p-10">
    <div
      class="max-w-7xl mx-auto mb-8 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4"
    >
      <div>
...
const fetchRooms = async () => {
  ...
  try {
    ...
    rooms.value = res.data.data.map((item) => ({
      ...
      // Tambahkan fasilitas untuk checklist di EditModal
...
const openEditModal = (room) => {
  ...
  currentRoom.value = {
    ...
    fasilitas: room.fasilitas || [], // Tambahkan fasilitas
  }
