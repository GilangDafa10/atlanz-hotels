<template>
  <div class="p-4 md:p-6">
    <h1 class="text-xl md:text-2xl font-bold mb-4 md:mb-6">Manajemen Pengguna (Users)</h1>
    ...
    <div v-else>
          ...
          <table class="min-w-full divide-y divide-gray-200">
            ...
            <tbody class="bg-white divide-y divide-gray-200">
              ...
              <tr v-for="user in userList" :key="user.id">
                <td class="px-4 lg:px-6 py-4 whitespace-nowrap text-sm">{{ user.id }}</td>
                <td class="px-4 lg:px-6 py-4 whitespace-nowrap font-medium text-sm">
                  {{ user.name }}
                </td>
      ...
      <div class="md:hidden space-y-4">
        <div v-if="userList.length === 0" class="bg-white rounded-lg p-6 text-center text-gray-500">
          Belum ada data pengguna.
        </div>
