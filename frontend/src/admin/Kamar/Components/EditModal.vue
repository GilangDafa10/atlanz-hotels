        ...
        <div class="bg-white rounded-2xl shadow-xl w-full max-w-lg p-6 relative z-10">
          <div class="flex justify-between items-center mb-6 border-b pb-4">
            <h3 class="text-xl font-bold text-gray-800">
              Edit Kamar: {{ initialForm.nomor_kamar }}
            </h3>
          ...
          <form @submit.prevent="submitUpdate" class="space-y-4">
            ...
            <div>
              ...
              >
                ...
                >
                  {{ jenis.jenis_kasur }} (Rp
                  {{ Number(jenis.harga_permalam).toLocaleString('id-ID') }})
                </option>
              </select>
            </div>
            ...
            <div class="flex justify-end gap-3 pt-4 border-t mt-4">
              ...
              <button
                ...
                class="px-5 py-2.5 bg-green-600 text-white font-medium rounded-lg hover:bg-green-700 transition disabled:opacity-50 flex items-center gap-2"
              >
                <span
                  v-if="isLoading"
...
watch(
  ...
  (newKamar) => {
    if (newKamar && newKamar.id_kamar) {
      ...
      // Cek apakah id_jenis_kamar ada di root level atau di dalam jenis_kamar object
      form.value.id_jenis_kamar =
        newKamar.id_jenis_kamar || newKamar.jenis_kamar?.id_jenis_kamar || null

      console.log('EditModal - Data received:', newKamar)
      console.log('EditModal - Form id_jenis_kamar:', form.value.id_jenis_kamar)
